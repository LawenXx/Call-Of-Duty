...
XNotifyQueueUI_t XNotifyQueueUI = XNotifyQueueUI_t(ResolveImport("xam.xex", 0x290));
XamGetCurrentTitleId_t XamGetCurrentTitleId = XamGetCurrentTitleId_t(ResolveImport("xam.xex", 0x1CF));
